...
export function Composer({
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="composer fixed left-1/2 -translate-x-1/2 bottom-6 z-[5] bg-card rounded-xl border border-border composer-shadow p-4 w-[min(768px,calc(100%-48px))] max-h-[50vh] flex flex-col overflow-hidden"
    >
      ...
      <div className="flex gap-2 items-stretch flex-1 min-h-0">
        ...
        <Button type="submit" disabled={disabled} className="flex-shrink-0 self-end">
          <span>Send</span>
